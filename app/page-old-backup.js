      ...
      <div className="container mx-auto px-6 py-20 relative">
        ...
        <div className="text-center mb-16 max-w-5xl mx-auto relative z-10">
          ...
          {session && (
            <div className="flex flex-col items-center gap-4 mb-6">
              <div className="flex items-center gap-4">
                <p className="text-2xl text-white">Welcome back, {session.user?.name || session.user?.email}!</p>
              </div>
              <Link 
                href="/dashboard" 
                className="bg-white dark:bg-white text-black dark:text-black px-8 py-3 rounded-full font-medium hover:bg-gray-200 transition-all shadow-lg inline-flex items-center gap-2"
              >
                Go to Dashboard
